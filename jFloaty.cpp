...
static void usage(const char* progName) {
  ...
  std::cerr << std::endl;
  std::cerr << "I/O Arguments:" << std::endl;
  ...
  std::cerr << std::endl;
  std::cerr << "Buffer Manipulation Arguments:" << std::endl;
  ...
  std::cerr << std::endl;
  std::cerr << "Example: RGBFFF -> JPG(Quality=95)" << std::endl;
  ...
  std::cerr << "Example: JPG -> PNG16" << std::endl;
  std::cerr << "\t" << progName << " -i input.jpg -o16 output.png" << std::endl;
  std::cerr << std::endl;
}
